...
export const pricingCards = [
  {
    title: "Začiatočník",
    description: "Ideálne pre vyskúšanie služby",
    price: "Zadarmo",
    duration: "",
    ...
    features: [
      "2 klienti",
      "2 členný tím",
      "Neobmedzený počet pracovných postupov",
    ],
    priceId: "",
  },
  {
    title: "Profesionál",
    description: "Dokonalá výbava pre agentúru",
    price: "€199",
    duration: "mesačne",
    highlight: "Key features",
    features: ["Prefakturovanie", "Tím podpory 24/7"],
  ...
  },
  {
    ...
    features: ["Neobmedzený počet klientov", "Neobmedzený počet členov tímu"],
    priceId: "price_1Or5qjBNoNakQl9kJgVJHN5f",
  },
];

export const addOnProducts = [
  { title: "Prioritná podpora", id: "prod_PgSsFbdNWCYw6R" },
];
